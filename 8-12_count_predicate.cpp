...
int main(int argc, char* argv[])
{
	...
	auto numberOfCapitals = count_if(myString.begin(), myString.end(),
									[](auto&& character) { return static_cast<bool>(isupper(character)); }
							);
	cout << "The number of capitals: " << numberOfCapitals << endl;

	auto numberOfLowerCase = count_if(myString.begin(), myString.end(),
									[](auto&& character)
									{
	...
	auto numberOfAlphaNumerics = count_if(myString.begin(), myString.end(),
										[](auto&& character)
										{
	...
	auto numberOfPunctuationMarks = count_if(myString.begin(), myString.end(),
											[](auto&& character)
											{
	...
	auto numberOfWhiteSpaceCharacters = count_if(myString.begin(), myString.end(),
												[](auto&& character)
												{
